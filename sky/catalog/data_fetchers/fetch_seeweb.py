...
FALLBACK_PLANS = [
    ...
    {'plan_name': 'eCS2', 'vcpus': 2, 'memory_gb': 4, 'price': 0.10, 'gpu_name': None, 'gpu_count': 0},
    {'plan_name': 'eCS4', 'vcpus': 4, 'memory_gb': 8, 'price': 0.20, 'gpu_name': None, 'gpu_count': 0},
    {'plan_name': 'eCS8', 'vcpus': 8, 'memory_gb': 16, 'price': 0.40, 'gpu_name': None, 'gpu_count': 0},
    
    # GPU instances - these might need adjustment based on actual Seeweb offerings
    {'plan_name': 'gCS4-RTX4090', 'vcpus': 4, 'memory_gb': 16, 'price': 1.50, 'gpu_name': 'RTX4090', 'gpu_count': 1},
    {'plan_name': 'gCS8-RTX4090', 'vcpus': 8, 'memory_gb': 32, 'price': 2.50, 'gpu_name': 'RTX4090', 'gpu_count': 1},
    {'plan_name': 'gCS4-A100', 'vcpus': 4, 'memory_gb': 16, 'price': 2.00, 'gpu_name': 'A100', 'gpu_count': 1},
    {'plan_name': 'gCS8-A100', 'vcpus': 8, 'memory_gb': 32, 'price': 3.00, 'gpu_name': 'A100', 'gpu_count': 1},
]
...
def parse_plan_info(plan: Any) -> Dict[str, Any]:
    ...
    if hasattr(plan, 'name'):
        ...
        try:
            memory_gb = int(memory_mb) / 1024 if memory_mb else 0  # Convert to GB
