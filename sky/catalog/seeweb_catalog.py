...
def validate_region_zone(
    ...
    return common.validate_region_zone_impl('Seeweb', _df, region, zone)
...
def list_accelerators(
    ...
    """Returns all instance types in Seeweb offering GPUs."""
    return common.list_accelerators_impl('Seeweb', _df, gpus_only,
